...
function getDashboardMainHTML() {
  return `
    ...
    <head>
        ...
        <script src="/static/url-redirect.js?v=4"></script>
    <script src="/static/url-redirect.js?v=4"></script>
    </head>
...
function getDashboardUmurHTML() {
  return `
    ...
    <body class="bg-gray-50">
        ...
        <script src="/static/auth-check.js?v=4"></script>
        <script src="/static/dashboard-umur.js?v=4"></script>
    </body>
    </html>
  `
}
...
function getDashboardMutasiHTML() {
  return `
    ...
    <body class="bg-gray-50">
        ...
        <script src="/static/auth-check.js?v=4"></script>
        <script src="/static/dashboard-mutasi.js?v=4"></script>
    </body>
    </html>
  `
}
