...
function getDashboardMainHTML() {
  return `
    ...
    <head>
        ...
        <script src="/url-redirect.js?v=1770000836"></script>
    <script src="/url-redirect.js?v=1770000836"></script>
    </head>
...
function getDashboardUmurHTML() {
  return `
    ...
    <body class="bg-gray-50">
        ...
        <script src="/dashboard-umur-8df16788.js?v=1770000836"></script>
    </body>
    </html>
  `
}
...
function getDashboardMutasiHTML() {
  return `
    ...
    <body class="bg-gray-50">
        ...
        <script src="/auth-check.js?v=1770000836"></script>
        <script src="/dashboard-mutasi-8df16788.js?v=1770000836"></script>
    </body>
    </html>
  `
}
