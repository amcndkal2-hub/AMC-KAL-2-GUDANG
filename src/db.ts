  ...
  try {
    ...
    for (const row of gangguanIds as any[]) {
      ...
      const gangguan = {
        ...
        user_laporan: firstMaterial?.user_laporan || 'Data Recovery',
        status: 'Open',
        catatan_tindakan: firstMaterial?.catatan_tindakan || null,
        rencana_perbaikan: firstMaterial?.rencana_perbaikan || null,
        ttd_teknisi: firstMaterial?.ttd_teknisi || null,
        ttd_supervisor: firstMaterial?.ttd_supervisor || null,
        ttd_pelapor: firstMaterial?.ttd_pelapor || null,
        nama_pelapor: firstMaterial?.nama_pelapor || null,
        ...
        beban_puncak: firstMaterial?.beban_puncak || 0,
        daya_mampu: firstMaterial?.daya_mampu || 0,
        pemadaman: firstMaterial?.pemadaman || 'NORMAL',
        kelompok_spd: firstMaterial?.kelompok_spd || 'MEKANIK',
